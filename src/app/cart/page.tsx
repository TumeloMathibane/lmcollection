...
export default function Cart() {
  ...
  return (
    <main className="min-h-[42em] md:min-h-[52em] lg:min-h-[64em] xl:min-h-[22em] xl:w-[80%] xl:place-self-center-safe">
      <p className="text-4xl text-stone-900 font-bold p-3 lg:px-5">Your cart</p>
      {items.length === 0 ? (
        <div>
        ...
        <div className="lg:flex lg:w-full">
          <div className="p-3 lg:p-5 lg:w-2/3">
            {items.map((item, key) => (
              <div
                key={key}
                className="w-full py-5 flex border-t last:border-b border-stone-400 space-x-3 md:space-x-5 xl:space-x-10"
              >
                ...
                <div className="item-info w-full relative">
                  <div className="flex items-center-safe justify-between">
                    ...
                    <BiX
                      size={"1.5em"}
                      onClick={() =>
                        removeItem(item.productId, item.productSize)
                      }
                    />
                  </div>
                  <div className="flex justify-between text-stone-600 font-light lg:text-xl">
                    <p>
