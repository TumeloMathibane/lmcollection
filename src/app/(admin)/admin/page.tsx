        ...
        <div className="flex flex-col h-full gap-3">
          <div>
            ...
            <div className="flex gap-5">
              {Array.from({ length: 3 }).map((_, index) => (
                <div key={index} className="border border-secondary p-3 flex-1 flex flex-col">
                  {index === 1 ? <Card
          ...
          <div className="flex-1 flex flex-col h-full gap-4">
            <div className="flex h-full gap-10">
              <div className="flex-1 border border-secondary">Content section 1</div>
              <div className="flex-1 border border-secondary">Content section 2</div>
            </div>
          </div>
        </div>
      </section>
