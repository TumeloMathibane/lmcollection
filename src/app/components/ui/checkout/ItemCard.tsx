  ...
  return (
    <div className="flex space-x-4">
      <div className="img relative">
        <div className="size-20 xl:size-15 overflow-hidden rounded-lg shadow-md h-fit">
      ...
      <div className="info w-full">
        <div className="flex justify-between">
          <p className="font-bold text-lg xl:text-md xl:font-semibold">
            {item.productName}
          </p>
        ...
        <p className="text-stone-500 xl:text-sm">Size: {item.productSize}</p>
      </div>
    </div>
  );
}
