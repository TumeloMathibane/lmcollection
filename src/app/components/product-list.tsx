      ...
      {products?.map(({ _id, name, price, images }) => (
        <Link key={_id} href={`/collection/products/${_id}`} className="w-full">
          <div className="w-full h-full bg-stone-100 shadow-sm rounded-xl overflow-hidden group hover:cursor-pointer relative">
            <figure className="overflow-hidden flex items-center w-45 h-auto sm:w-full">
            ...
            <div className="px-3 py-1 transition-all duration-300 ease-out lg:translate-y-[150%] lg:absolute bottom-0 left-0 right-0 group-hover:translate-0 lg:bg-stone-100">
