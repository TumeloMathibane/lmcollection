...
//! TODO  [?]: Admin - search 'continue from here' in project and carry on...
//! TODO  [?]: Admin 'products' - continue implementing product edit functionality, and add product deletion functionality...
//! TODO  [ ]: Admin 'add product form' - if possible, implement method to select primary image from selected images
//! TODO  [ ]: Admin 'sidebar' - add store name or blank div to the bottom of sidebar to make logged in user info visible
